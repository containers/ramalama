...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            marks=pytest.mark.xfail(sys.platform.startswith("win"), reason="broken test on windows")
        )
        # fmt: on
    ],
)
...
@pytest.mark.xfail(sys.platform.startswith("win"), reason="broken test on windows")
