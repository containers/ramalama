...
.PHONY: e2e-tests-no-container
e2e-tests-no-container:
...
end-to-end-tests: validate e2e-tests e2e-tests-no-container

.PHONY: ci-end-to-end-tests
ci-end-to-end-tests: validate e2e-tests e2e-tests-no-container
	test/ci.sh
