...
from ramalama.chat_api_llama_server import LlamaServerAPI, handle_context_overflow
...
from ramalama.summarizer import ObservationMasking, LLMSummarizer
...
class RamaLamaShell(cmd.Cmd):
    def __init__(self, args: ChatArgsType, operational_args: ChatOperationalArgs | None = None):
        ...
        self.server_api = LlamaServerAPI(args.url)
