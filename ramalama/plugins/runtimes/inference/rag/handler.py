...
def rag_handler(plugin: RuntimePlugin, args: argparse.Namespace) -> None:
    ...
    docling_serve_args = _build_serve_args(
        ...
        name=rag_stack_container_name(base_name, RAG_ROLE_DOCLING),
    )
    embed_serve_args = _build_serve_args(
        ...
        cache_reuse=0,
        name=rag_stack_container_name(base_name, RAG_ROLE_EMBEDDING),
    )
    ...
    if caption_model and caption_port:
        caption_serve_args = _build_serve_args(
            ...
            ctx_size=vlm_ctx_size,
            cache_reuse=0,
            name=rag_stack_container_name(base_name, RAG_ROLE_CAPTIONING),
        )
