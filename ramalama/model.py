...
from ramalama.config import DEFAULT_PORT
...
def compute_ports() -> list:
    range_size = 10
    ports = list(range(DEFAULT_PORT + 1, DEFAULT_PORT + range_size + 1))
    random.shuffle(ports)
    # try always the default port first
    return [DEFAULT_PORT] + ports
