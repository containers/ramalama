...
def pull_blob(repos, layer_digest, accept, registry_head, models, model_name, model_tag, model_path, show_progress, in_existing_cache_fn=None):
    """
...
def repo_pull(repos, accept, registry_head, model_name, model_tag, models, model_path, model, show_progress, 
              media_type="application/vnd.ollama.image.model", in_existing_cache_fn=None):
    """
    ...
    for layer in manifest_data["layers"]:
        ...
        pull_blob(repos, layer_digest, accept, registry_head, models, model_name, model_tag, 
                 model_path, show_progress, in_existing_cache_fn)
